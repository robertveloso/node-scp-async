    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    err_6 = _a.sent();
                    throw formatError(err_6, 'normalizeRemotePath');
                case 6: return [2 /*return*/];
            }
        });
    });
...
function joinRemote(client) {
    ...
    if (client.remotePathSep === '/') {
        return (_a = path_1.default.posix).join.apply(_a, args);
    }
    return (_b = path_1.default.win32).join.apply(_b, args);
}
